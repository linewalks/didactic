...
/***/ "./src/helpers/getConfig.js":
/*!**********************************!*\
  !*** ./src/helpers/getConfig.js ***!
  \**********************************/
/*! exports provided: getConfigFromExternalPath */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getConfigFromExternalPath\", function() { return getConfigFromExternalPath; });\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fs */ \"fs\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var chalk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! chalk */ \"chalk\");\n/* harmony import */ var chalk__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(chalk__WEBPACK_IMPORTED_MODULE_1__);\n\n\nvar getConfigFromExternalPath = function getConfigFromExternalPath(path) {\n  var configPath = \"./config.json\";\n\n  if (path) {\n    configPath = path;\n  }\n\n  try {\n    var config = JSON.parse(fs__WEBPACK_IMPORTED_MODULE_0___default.a.readFileSync(configPath));\n    var requiredConfigs = [\"port\", \"contractsPath\", \"host\", \"networkId\"];\n    requiredConfigs.forEach(function (configKey) {\n      if (!Object.keys(config).includes(configKey)) {\n        console.log(chalk__WEBPACK_IMPORTED_MODULE_1___default.a.yellow(\"\".concat(configKey, \" is not provided; using default value as fallback\")));\n      }\n    });\n    var _config$port = config.port,\n        port = _config$port === void 0 ? \"8081\" : _config$port,\n        _config$contractsPath = config.contractsPath,\n        contractsPath = _config$contractsPath === void 0 ? \"../build/contracts\" : _config$contractsPath,\n        _config$host = config.host,\n        host = _config$host === void 0 ? \"http://localhost\" : _config$host,\n        _config$networkId = config.networkId,\n        networkId = _config$networkId === void 0 ? \"*\" : _config$networkId,\n        _config$deployedContr = config.deployedContractsHashes,\n        deployedContractsHashes = _config$deployedContr === void 0 ? [] : _config$deployedContr;\n    return {\n      port: port,\n      contractsPath: contractsPath,\n      host: host,\n      networkId: networkId,\n      deployedContractsHashes: deployedContractsHashes\n    };\n  } catch (e) {\n    console.log(chalk__WEBPACK_IMPORTED_MODULE_1___default.a.yellow(\"Failed to load config from file, failing silently...\"));\n    return {};\n  }\n};\n\n//# sourceURL=webpack:///./src/helpers/getConfig.js?");
